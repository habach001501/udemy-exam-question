const neal_3 = {
  ...
  results: [
    ...
    },
    {
      ...
      section: "AWS Storage",
      question_plain:
        "An application running on an Amazon EC2 instance stores sensitive data on an attached Amazon EBS volume. The volume is not encrypted. A DevOps engineer must enable encryption at rest for the data.Which actions should the engineer take? (Select TWO.)",
      related_lectures: [],
    },
    {
      _class: "assessment",
    ...
    },
    {
      ...
      prompt: {
        question:
          "<p>A DevOps engineer is deploying a series of updates to a web application that runs on Amazon EC2 instances in an Auto Scaling group behind an Application Load Balancer. The updates are being deployed using a blue/green strategy with immutable instances.</p><p>An issue has been occurring where users are being logged of the application during deployments. The DevOps engineer needs to ensure that users remain logged in when scaling events occur and application updates are deployed.</p><p>How can these requirements be met with the LOWEST latency?</p>",
        relatedLectureIds: "",
        feedbacks: ["", "", "", ""],
        explanation:
