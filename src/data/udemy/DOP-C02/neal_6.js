  ...
  results: [
    ...
    },
    {
      ...
      prompt: {
        ...
        answers: [
          "<p>Activate the user-defined cost allocation tags in each AWS account.</p>",
          "<p>Create and attach an SCP that requires tags to be specified when creating resources.</p>",
          "<p>Define each application in AWS Budgets. Assign the required tag to each resource.</p>",
          "<p>Scan all accounts with Tag Editor. Assign the required tag to each resource.</p>",
          "<p>Use the budget report to find untagged resources. Assign tags to the resources.</p>",
        ],
      },
    ...
    },
    {
      ...
      prompt: {
        question:
          "<p>A DevOps Engineer must deploy a three-tier web application on AWS. The application will run on Amazon EC2 instances and will use an Amazon RDS database tier. The engineer must select a deployment model that reduces operational overhead as much as possible.<br>Which solution best meets these requirements?</p>",
        relatedLectureIds: [],
        links: [],
        feedbacks: ["", "", "", ""],
        explanation:
          '<p>AWS Elastic Beanstalk provides a managed platform for deploying and operating applications on AWS. It automatically provisions and manages Application Load Balancers, Auto Scaling groups, EC2 instances, and Amazon RDS. Elastic Beanstalk also manages application deployments, health monitoring, scaling, and updates, which reduces operational effort.</p><p><strong>CORRECT:</strong> "Use AWS Elastic Beanstalk to create an Application Load Balancer, an Auto Scaling group, and application and database resources. Deploy application updates using Elastic Beanstalk managed deployments" is the correct answer (as explained above.)</p><p><strong>INCORRECT:</strong> "Use AWS CloudFormation to create an Application Load Balancer and an Auto Scaling group. Use AWS Elastic Beanstalk to create the application and database resources. Deploy application updates using Elastic Beanstalk deployments" is incorrect.<br>Splitting responsibility between CloudFormation and Elastic Beanstalk increases complexity and operational overhead. Elastic Beanstalk should manage the full stack.</p><p><strong>INCORRECT:</strong> "Use AWS Elastic Beanstalk to create an Application Load Balancer, an Auto Scaling group, and application resources. Use AWS CloudFormation to create the database resources. Deploy application updates using CloudFormation rolling updates" is incorrect.<br>Elastic Beanstalk can manage the database tier directly. Mixing deployment tools adds unnecessary complexity.</p><p><strong>INCORRECT:</strong> "Use AWS CloudFormation to create an Application Load Balancer, an Auto Scaling group, and database resources. Deploy application updates using CloudFormation rolling updates" is incorrect.<br>CloudFormation is well suited to provisioning infrastructure but is not designed for ongoing application deployments. Elastic Beanstalk better meets the requirement to reduce operational overhead.</p><p><strong>References:</strong></p><p><a href="https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/using-features.managing.elb.html">https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/using-features.managing.elb.html</a></p><p><strong>Save time with our exam-specific cheat sheets:</strong></p><p><a href="https://digitalcloud.training/aws-elastic-beanstalk/">https://digitalcloud.training/aws-elastic-beanstalk/</a></p>',
        answers: [
          "<p>Use AWS CloudFormation to create an Application Load Balancer and an Auto Scaling group. Use AWS Elastic Beanstalk to create the application and database resources. Deploy application updates using Elastic Beanstalk deployments.</p>",
          "<p>Use AWS Elastic Beanstalk to create an Application Load Balancer, an Auto Scaling group, and application and database resources. Deploy application updates using Elastic Beanstalk managed deployments.</p>",
          "<p>Use AWS Elastic Beanstalk to create an Application Load Balancer, an Auto Scaling group, and application resources. Use AWS CloudFormation to create the database resources. Deploy application updates using CloudFormation rolling updates.</p>",
          "<p>Use AWS CloudFormation to create an Application Load Balancer, an Auto Scaling group, and database resources. Deploy application updates using CloudFormation rolling updates.</p>",
        ],
      },
      correct_response: ["b"],
      section: "AWS Management & Governance",
      question_plain:
        "A DevOps Engineer must deploy a three-tier web application on AWS. The application will run on Amazon EC2 instances and will use an Amazon RDS database tier. The engineer must select a deployment model that reduces operational overhead as much as possible.Which solution best meets these requirements?",
      related_lectures: [],
    },
    {
      _class: "assessment",
    ...
    },
    {
      ...
      prompt: {
        ...
        answers: [
          "<p>Create an Amazon EC2 Auto Scaling group and configure the minimum, maximum, and desired capacity to 1.</p>",
          ...
          "<p>Create a spread placement group configured across distinct underlying hardware. Enable automatic recovery.</p>",
    ...
    },
    {
      ...
      section: "AWS Networking & Content Delivery",
      question_plain:
        "An application runs on Amazon EC2 instances in an Auto Scaling group behind an Application Load Balancer (ALB). The application is used by users around the world who access the application using a custom DNS domain name. The application must support encryption in transit, be protected from DDoS attacks and web exploits, should be optimized for performance.Which actions should a DevOps engineer take to meet these requirements? (Select TWO.)",
      related_lectures: [],
    },
    {
      _class: "assessment",
